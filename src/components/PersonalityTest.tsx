...
export default function PersonalityTest() {
  ...
  const calculateFitmentScore = () => {
    ...
    const { extraversion, agreeableness, openness, neuroticism, conscientiousness } = scores;
    ...
    return (extraversion + agreeableness + openness + invertedNeuroticism + conscientiousness) / 5;
  };
